(function ($) {
    ...
    //30.Countdown Timer
    if ($('.countdown').length) {
        $('.countdown').countdown(fechaEvento, function (event) {
            var $this = $(this).html(
                    event.strftime(
                            '' +
                            '<div class="counter-column"><span class="count">%D</span><br><h6>Días</h6></div> ' +
                            '<div class="counter-column"><span class="count">%H</span><span class="colon"></span><br><h6>Horas</h6></div>  ' +
                            '<div class="counter-column"><span class="count">%M</span><span class="colon"></span><br><h6>Minutos</h6></div>  ' +
                            '<div class="counter-column"><span class="count">%S</span><span class="colon"></span><br><h6>Segundos</h6></div>'
                            )
                    );
        });
    }
